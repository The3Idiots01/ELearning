...
public enum ErrorCode {
    ...
    // Course Review Domain (1341 - 1346)
    REVIEW_NOT_FOUND(1341, "Review not found", HttpStatus.NOT_FOUND),
    REVIEW_ACCESS_DENIED(1342, "You do not have permission to modify this review", HttpStatus.FORBIDDEN),
    REVIEW_NOT_ENROLLED(1343, "Chỉ học viên đã đăng ký khóa học mới có thể đánh giá", HttpStatus.FORBIDDEN),
    REVIEW_CONTENT_VIOLATION(1344, "Nội dung đánh giá chứa từ ngữ chưa phù hợp hoặc vi phạm tiêu chuẩn cộng đồng. Vui lòng chỉnh sửa lại.", HttpStatus.BAD_REQUEST),
    REVIEW_INVALID_RATING(1345, "Số sao đánh giá phải từ 1 đến 5", HttpStatus.BAD_REQUEST),
    REVIEW_PROGRESS_INSUFFICIENT(1346, "Bạn cần hoàn thành ít nhất 20% khóa học để có thể gửi đánh giá", HttpStatus.FORBIDDEN);
