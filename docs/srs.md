...
**Out of scope:** 
- Không bao gồm nghiệp vụ quản lý lớp học có lịch cố định: điểm danh, xếp lớp, ...
...
| FR-AUTH-02 | Đăng nhập và duy trì phiên | Phiên hết hạn sau thời gian cấu hình | Must | 1 | BR-02, BR-03 |
| FR-AUTH-03 | Người dùng chọn đăng nhập bằng google/facebook | Đăng nhập thành công , Phiên hết hạn sau thời gian cấu hình | Should | 1 | BR-02, BR-03 |
...
| NFR-02 | Security | URL video có chữ ký, hết hạn sau ≤ 15 phút |
| NFR-03 | Security | Phân quyền kiểm tra ở server cho mọi endpoint |
| NFR-04 | Reliability | Enrollment chỉ tạo từ xác nhận server-to-server |
| NFR-05 | Reliability | Lỗi của AI hoặc email không gián đoạn luồng học và luồng thanh toán |
| NFR-06 | Usability | Responsive, hoạt động trên màn hình ≥ 360px |
| NFR-07 | Compatibility | Chrome, Edge, Firefox, Safari phiên bản mới nhất |
| NFR-08 | Maintainability | Code theo convention thống nhất, README hướng dẫn chạy local |
...
| BR-17 | Chứng chỉ được cấp khi watched coverage toàn course ≥ 90% và qua bài test (nếu có) | FR-KT-05 |
